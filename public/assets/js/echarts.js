...
(function () {
    ...
    option = {
        ...
        color: ["rgb(235, 77, 75)", "rgb(215, 124, 247)", "rgb(244, 167, 66)", "rgb(12, 163, 231)", "rgb(254, 84, 84)"]
    };
    if (option && typeof option === 'object') {
        myChart.setOption(option);
    }
    ...
    option = {
        ...
        color: ["rgb(235, 77, 75)", "rgb(215, 124, 247)", "rgb(244, 167, 66)", "rgb(254, 84, 84)"]
    };
    if (option && typeof option === 'object') {
        myChart.setOption(option);
    }
    ...
    option = {
        ...
        color: ["rgb(235, 77, 75)", "rgb(215, 124, 247)"]
    };
    if (option && typeof option === 'object') {
        myChart.setOption(option);
    }
    ...
    option = {
        ...
        color: ["rgb(235, 77, 75)", "rgb(215, 124, 247)", "rgb(244, 167, 66)", "rgb(254, 84, 84)", "rgb(12, 163, 231)"]
    };
    if (option && typeof option === 'object') {
        myChart.setOption(option);
    }
