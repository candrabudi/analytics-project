(function () {
    ...
    var options = {
        ...
        colors: ["#8b0000", "#d77cf7", "#f4a742", "#fe5454"],
        responsive: [{
            breakpoint: 480,
            options: {
                legend: {
    ...
    var colors = ['#8b0000', '#d77cf7', '#f4a742', '#0ca3e7', '#fe5454', '#0cd7b1', '#7b76fe'];
    ...
    var options = {
        ...
        colors: ['#8b0000', '#d77cf7', '#f4a742', '#0ca3e7', '#fe5454', '#0cd7b1', '#7b76fe', '#fe7c58'],
        plotOptions: {
            bar: {
                columnWidth: '45%',
                distributed: true,
