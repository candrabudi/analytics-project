    ...
    <div class="main-sidebar" id="sidebar-scroll">
        ...
        <nav class="main-menu-container nav nav-pills flex-column sub-open">
            ...
            <ul class="main-menu">
                ...
                <li class="slide">
                    <a href="{{ route('databae_raw.upload') }}" class="side-menu__item">
                        <i class="side-menu__icon ri-archive-drawer-line"></i>
                        <span class="side-menu__label">Import Data</span>
                    </a>
                </li>
                <li class="slide">
                    <a href="{{ route('databae_raw.list') }}" class="side-menu__item">
                        <i class="side-menu__icon ri-database-2-line"></i>
                        <span class="side-menu__label">Raw Data</span>
                    </a>
                </li>
